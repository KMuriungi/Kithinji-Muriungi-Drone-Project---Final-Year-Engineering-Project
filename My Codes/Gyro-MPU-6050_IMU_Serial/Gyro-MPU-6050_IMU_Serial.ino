...
void setup() {
  ...
  Serial.begin(57600);                                                 //Set the LCD cursor to position to position 0,0
  Serial.println("    MPU-6050 IMU");                                         //Print text to screen
                                                    //Set the LCD cursor to position to position 0,1
  Serial.println("        GYRO");                                              //Print text to screen

  delay(1500);                                                          //Set the LCD cursor to position to position 0,0
  ...
  Serial.print("Pitch: ");                                                //Set the LCD cursor to position to position 0,1
...
void loop(){
  ...
  write_Serial();                                                         //Write the roll and pitch values to the LCD display
