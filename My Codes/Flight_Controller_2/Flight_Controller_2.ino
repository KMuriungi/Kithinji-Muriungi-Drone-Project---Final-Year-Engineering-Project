...
void setup(){
  ...
  for (cal_int = 0; cal_int < 2000 ; cal_int ++){              //Take 2000 readings for calibration.
    ...
    //if(cal_int % 125 == 0)Serial.println(".");
    gyro_signalen();                                           //Read the gyro output.
    Serial.println("Gyro Output");
  ...
  Serial.println("GYRO Config Complete");
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Video Sample: www.youtube.com/watch?v=JBvnB0279-Q
