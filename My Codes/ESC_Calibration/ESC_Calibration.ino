...
void setup(){
 ...
 Serial.print("Serial Is Ready3 ------> "+  gyro_address);
  set_gyro_registers(); 
   Serial.print("Serial Is Ready4");//Set the specific gyro registers.

   for(data = 0; data <= 35; data++){
    Serial.print("Serial Is Ready4"  + eeprom_data[data]);
   }
  ...
  Serial.print("Serial Is Ready5");
  wait_for_receiver();  
  Serial.print("Serial Is Ready6");//Wait until the receiver is active.
